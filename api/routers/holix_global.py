...
router = APIRouter(prefix="/api/holix/global", tags=["holix-global"], route_class=DishkaRoute)
...
def _admin_context(
    ...
    ctx = profile_access(host_profile, key_info, x_holix_profile, x_holix_profile_key)
...
async def init_global(
    ...
    _admin_context(str(host_profile), key_info, x_holix_profile, x_holix_profile_key)
