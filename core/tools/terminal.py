...
class TerminalTool(BaseTool):
    ...
    def __init__(self):
        ...
        self.description = (
            ...
            "user asked you to run them in the foreground — persistent servers "
            "go to start_background_process only when the user asked to run "
            "in the background or to start/keep a server. "
