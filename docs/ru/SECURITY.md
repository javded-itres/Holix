...
6. Telegram: `HELIX_TELEGRAM_ACCESS_REQUESTS=true` (по умолчанию после `telegram setup`) или `HELIX_TELEGRAM_ALLOWED_USERS` для личного бота; в production — именованные профили (`-p shared`), не `default`
