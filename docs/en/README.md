...
- [TUI.md](TUI.md) — queue, todos, live process bar, copy
...
- [HUB.md](HUB.md) · [BROWSER_TOOLS.md](BROWSER_TOOLS.md) · [TOOLS.md](TOOLS.md) — `lsp`, `tool_search`, `send_chat_files`, `self_diagnose`, `research_site_pages`
- [MCP.md](MCP.md) · [MEMORY.md](MEMORY.md) — Chroma or pgvector

### Agents & automation

- [SUBAGENTS.md](SUBAGENTS.md) — types (TUI + Telegram/MAX), spawn, **supervisor**
- [ACP.md](ACP.md) — out-of-process coding agents (`run_acp_agent`)
